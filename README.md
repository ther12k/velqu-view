...
| M5 | Velqu Reactive v0 (isolated UI QuickJS) — **M5a runtime gate** (ADR 0015) and **M5b binding compiler** (ADR 0016) done; M5c state+events and M5d invalidation next | in progress |
