...
| M6 | VelquView Lab inspector + reload — **M6a.1 event ownership** (ADR 0019: `pump_reactive` takes a caller-owned batch, never the queue) done; M6a inspector, M6b transactional reload, M6c file watching next | in progress |
