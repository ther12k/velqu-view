...
| M5 | Velqu Reactive v0 (isolated UI QuickJS) — **M5a runtime gate done**: bounded QuickJS, hostile-script battery ([ADR 0015](docs/decisions/0015-m5a-runtime-gate.md)); M5b–M5d next | in progress |
